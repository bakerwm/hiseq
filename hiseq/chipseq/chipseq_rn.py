...
class ChipseqRnConfig(object):
    ...
    def init_fq(self):
        ...
        if self.smp_name is None:
            fname = fx_name(self.fq1, fix_pe=self.is_paired, fix_rep=True)
        ...
        # update rep_list
        self.rep_list = [
            os.path.join(self.outdir, i) for i in fx_name(
                self.fq1, fix_pe=self.is_paired)
        ]
