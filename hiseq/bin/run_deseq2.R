...
##----------------------------------------------------------------------------##
## custom: a.vs.b
rnaseq_pipe(deseq_dir, feature, ctl_vs_exp = TRUE)

##----------------------------------------------------------------------------##
## custom: b.vs.a
rnaseq_pipe(deseq_dir, feature, ctl_vs_exp = FALSE)
...
# hiseqr::deseq_hub2(count_ctl = pd_data$count_ctl,
...
# tmp <- hiseqr::DESeq2_publish_plot(cnt_fix1, outdir1, save2pdf = TRUE)
#
#
# ##----------------------------------------------------------------------------##
# ## custom: b.vs.a
# outdir2 <- file.path(pd_data$deseqdir, "treatment.vs.control")
# hiseqr::deseq_hub2(count_ctl = pd_data$count_exp,
